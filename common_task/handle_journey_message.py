...
class ChekMessageParser:
    ...
    def parse(self):
        ...
        data = {
                ...
                "invervention_mpi": float(self.chek_message.journeyStatistics.auto.intervention_statistics.mpi) if self.chek_message.journeyStatistics and self.chek_message.journeyStatistics.auto and self.chek_message.journeyStatistics.auto.intervention_statistics.mpi else None,
                "invervention_risk_mpi": float(self.chek_message.journeyStatistics.auto.intervention_statistics.risk_mpi) if self.chek_message.journeyStatistics and self.chek_message.journeyStatistics.auto and self.chek_message.journeyStatistics.auto.intervention_statistics.risk_mpi else None,
                ...
                "noa_invervention_risk_mpi": float(self.chek_message.journeyStatistics.noa.intervention_statistics.risk_mpi) if self.chek_message.journeyStatistics and self.chek_message.journeyStatistics.noa and self.chek_message.journeyStatistics.noa.intervention_statistics.risk_mpi else None,
                "noa_invervention_mpi": float(self.chek_message.journeyStatistics.noa.intervention_statistics.mpi) if self.chek_message.journeyStatistics and self.chek_message.journeyStatistics.noa and self.chek_message.journeyStatistics.noa.intervention_statistics.mpi else None,
                ...
                "lcc_invervention_risk_mpi": float(self.chek_message.journeyStatistics.lcc.intervention_statistics.risk_mpi) if self.chek_message.journeyStatistics and self.chek_message.journeyStatistics.lcc and self.chek_message.journeyStatistics.lcc.intervention_statistics.risk_mpi else None,
                "lcc_invervention_mpi": float(self.chek_message.journeyStatistics.lcc.intervention_statistics.mpi) if self.chek_message.journeyStatistics and self.chek_message.journeyStatistics.lcc and self.chek_message.journeyStatistics.lcc.intervention_statistics.mpi else None,
